...
{
    {
        ...
        assert(path1 ==
               Path({ins.G->V[0], ins.G->V[1], ins.G->V[2], ins.G->V[3]}));
        ...
        assert(path2 == Path({ins.G->V[0], ins.G->V[0], ins.G->V[1],
                              ins.G->V[2], ins.G->V[3]}));
        ...
        assert(path3 == Path({ins.G->V[0], ins.G->V[0], ins.G->V[0],
                              ins.G->V[1], ins.G->V[2], ins.G->V[3]}));
    }
