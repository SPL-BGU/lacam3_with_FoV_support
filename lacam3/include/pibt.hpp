...
struct PIBT {
   ...
   * @return std::set<size_t> The set of agents that were moved to make room for
   * i (including i).
   */
  ...
  /**
   * @brief De-occupies the entire field of view of the given node to be of the
   * given agent.
   *
   ...
   * @param occupied_field_of_view The occupied field of view vector to check if
   * the node is in the field of view of another agent's group.
